...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, fr.polytech.info4.domain.Client.class.getName() + ".orders");
            ...
            createCache(cm, fr.polytech.info4.domain.DeliveryMan.class.getName());
            createCache(cm, fr.polytech.info4.domain.DeliveryMan.class.getName() + ".orders");
