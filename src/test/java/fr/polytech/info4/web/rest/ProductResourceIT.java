...
class ProductResourceIT {
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productId(UPDATED_PRODUCT_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productId(UPDATED_PRODUCT_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
