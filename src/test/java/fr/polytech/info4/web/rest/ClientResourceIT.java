...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().phone(DEFAULT_PHONE).name(DEFAULT_NAME).surname(DEFAULT_SURNAME).address(DEFAULT_ADDRESS);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().phone(UPDATED_PHONE).name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.phone(UPDATED_PHONE).name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.surname(UPDATED_SURNAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.phone(UPDATED_PHONE).name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS);
